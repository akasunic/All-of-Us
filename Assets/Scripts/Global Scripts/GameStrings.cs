        ...
        {"English", new Dictionary<string, string>
            {
                ...
                {"talk_bubble_rashad_1", "Rashad1"},
                {"talk_bubble_rashad_2", "Rashad2"},
                {"talk_bubble_lee_1", "Lee1"},
                {"talk_bubble_lee_2", "Lee2"},
                {"talk_bubble_calindas_1", "Calindas1"},
                {"talk_bubble_calindas_2", "Calindas2"},
                {"talk_bubble_lila_1", "Lila1"},
                {"talk_bubble_lila_2", "Lila2"},
                {"talk_bubble_elisa_1", "Elisa1"},
                {"talk_bubble_elisa_2", "Elisa2"},
